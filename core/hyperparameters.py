...
cv2.createTrackbar(
    "Min - V",
    title_window,
    params.thresh_pen_min[2],
    255,
    params.updatePenThresholdsCallback(False, 2),
)

cv2.createTrackbar("Save", title_window, 0, 1, params.exportParameters)
